...
<div>
        ...
        <div >
            <table>
                <tr>
                    ...
                    <td>
                        <input id="search" type="text" style="background-repeat: no-repeat;" title="검색" :placeholder="searchWord">
                    </td>
    ...
    <template v-slot:default>
        ...
        <tr>
            ...
            <th class="text-left">곡</th>
            <th class="text-left">노래제목</th>
            <th class="text-left">아티스트</th>
        </tr>
        </thead>
        <tbody>
        <tr v-for="item in bugsmusic" :key="item.seq">
            <td>{{item.seq}}</td>
